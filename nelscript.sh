...
if [[ $vps = "vps" ]]; then
	source="https://raw.githubusercontent.com/nel003/autoscript1/master"
else
	source="https://raw.githubusercontent.com/nel003/autoscript1/master"
fi
...
echo "Modified by Nel03"  | tee -a log-install.txt
echo ""  | tee -a log-install.txt
...
echo "             (http://phcorner.net/ - fb.com/Nel.lopena)           "  | tee -a log-install.txt
echo "" | tee -a log-install.txt
